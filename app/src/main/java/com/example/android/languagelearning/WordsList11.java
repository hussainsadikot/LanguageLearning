...
public class WordsList11 extends Fragment {
    ...
    public static final String SHARED_PREFS_11 = "sharedPrefs_11";
    public static final String TEXT_MASTER_11 = "text_master_11";
    public static final String PROGRESS_MASTER_11 = "progress_master_11";
    public static final String TEXT_LEARNING_11 = "text_learning_11";
    public static final String PROGRESS_LEARNING_11 = "progress_learning_11";
    public static final String TEXT_REVIEWING_11 = "text_reviewing_11";
    public static final String PROGRESS_REVIEWING_11 = "progress_reviewing_11";
    public static final String TEXT_WORD1_11 = "text_word_11";
    public static final String TEXT_DEFINITION_11 = "text_def_11";
    public static final String WORD_LIST_SIZE_11 = "word_list_size_11";
    public static final String WORD_INDEX_11 = "word_index_11";
    // shared variable default loading
    private   String text_master_11="";
    public Integer progress_master_11=0;
    public  String text_learning_11="";
    public  Integer progress_learning_11=0;
    public String text_reviewing_11="";
    public  Integer progress_reviewing_11=0;
    public  String text_word_11="";
    public  String text_def_11="";
    public int word_list_size_11 =0;
    public int word_index_11;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] words1= getActivity().getResources().getStringArray(R.array.XXI_Communication_Verbs__XXII_Stationary_Verbs__XXIII_In_cohetive_Verbs__XXIV_Cognitive_Verbs__XXV_Sensory_and_Emotive_Verbs__XXVI_Other_Verbs__Array_List_11);
        String[] words_definition1= getActivity().getResources().getStringArray(R.array.Definition_Array_List_11);
...
//            word_index_1=word_index_1+1 ;
    ...
    private void saveData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(this.getActivity()).getSharedPreferences(SHARED_PREFS_11, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=  sharedPreferences.edit();
        editor.putString(TEXT_MASTER_11,tvProgressMaster.getText().toString());
        editor.putString(TEXT_REVIEWING_11,tvProgressReview.getText().toString());
        editor.putString(TEXT_LEARNING_11,tvProgressLearning.getText().toString());
        ...
        editor.putString(TEXT_WORD1_11, text_word_to_store);
        editor.putString(TEXT_DEFINITION_11,text_word_def_to_store);
        editor.putInt(PROGRESS_MASTER_11,progressBarMaster.getProgress());
        editor.putInt(PROGRESS_LEARNING_11,progressBarLearning.getProgress());
        editor.putInt(PROGRESS_REVIEWING_11,progressBarReview.getProgress());
        editor.putInt(WORD_LIST_SIZE_11,words.length);
        editor.putInt(WORD_INDEX_11,mGlobalWordNumber);
...
//        loadData();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(getActivity()).getSharedPreferences(SHARED_PREFS_11, Context.MODE_PRIVATE);
        word_index_11=sharedPreferences.getInt(WORD_INDEX_11,mGlobalWordNumber);
        text_master_11=sharedPreferences.getString(TEXT_MASTER_11,tvProgressMaster.getText().toString());
        progress_master_11=sharedPreferences.getInt(PROGRESS_MASTER_11,progressBarMaster.getProgress());
        text_learning_11=sharedPreferences.getString(TEXT_LEARNING_11,tvProgressLearning.getText().toString());
        progress_learning_11=sharedPreferences.getInt(PROGRESS_LEARNING_11,progressBarLearning.getProgress());
        text_reviewing_11=sharedPreferences.getString(TEXT_REVIEWING_11,tvProgressReview.getText().toString());
        progress_reviewing_11=sharedPreferences.getInt(PROGRESS_REVIEWING_11,progressBarReview.getProgress());

        text_word_11=sharedPreferences.getString(TEXT_WORD1_11,words[0]);




        text_def_11=sharedPreferences.getString(TEXT_DEFINITION_11,words_definition[0]);
        word_list_size_11= sharedPreferences.getInt(WORD_LIST_SIZE_11,words.length);
...
//            }
//        }
        tvProgressMaster.setText(text_master_11);
        mGlobalWordNumber=word_index_11;
        tvProgressReview.setText(text_reviewing_11);
        tvProgressLearning.setText(text_learning_11);
        for(int i =0 ; i<words.length; i++){
            if(words[i].equals(text_word_11)){
                word_index_11=i;
            }
        }
        textView_title_front.setText(text_word_11);
        textView_title_back.setText(text_word_11);

        textView_definition.setText(text_def_11);
        progressBarMaster.setProgress((progress_master_11));
        progressBarReview.setProgress((progress_reviewing_11) );
        progressBarLearning.setProgress((progress_learning_11));

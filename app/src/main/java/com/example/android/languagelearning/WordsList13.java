...
public class WordsList13 extends Fragment {
    ...
    public static final String SHARED_PREFS_13 = "sharedPrefs_13";
    public static final String TEXT_MASTER_13 = "text_master_13";
    public static final String PROGRESS_MASTER_13 = "progress_master_13";
    public static final String TEXT_LEARNING_13 = "text_learning_13";
    public static final String PROGRESS_LEARNING_13 = "progress_learning_13";
    public static final String TEXT_REVIEWING_13 = "text_reviewing_13";
    public static final String PROGRESS_REVIEWING_13 = "progress_reviewing_13";
    public static final String TEXT_WORD1_13 = "text_word_13";
    public static final String TEXT_DEFINITION_13 = "text_def_13";
    public static final String WORD_LIST_SIZE_13 = "word_list_size_13";
    public static final String WORD_INDEX_13 = "word_index_13";
    // shared variable default loading
    private   String text_master_13="";
    public Integer progress_master_13=0;
    public  String text_learning_13="";
    public  Integer progress_learning_13=0;
    public String text_reviewing_13="";
    public  Integer progress_reviewing_13=0;
    public  String text_word_13="";
    public  String text_def_13="";
    public int word_list_size_13 =0;
    public int word_index_13;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] words1= getActivity().getResources().getStringArray(R.array.XXVIII_Functional_Words_Part_1__Array_List_13);
        String[] words_definition1= getActivity().getResources().getStringArray(R.array.Definition_Array_List_13);
...
//            word_index_1=word_index_1+1 ;
    ...
    private void saveData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(this.getActivity()).getSharedPreferences(SHARED_PREFS_13, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=  sharedPreferences.edit();
        editor.putString(TEXT_MASTER_13,tvProgressMaster.getText().toString());
        editor.putString(TEXT_REVIEWING_13,tvProgressReview.getText().toString());
        editor.putString(TEXT_LEARNING_13,tvProgressLearning.getText().toString());
        ...
        editor.putString(TEXT_WORD1_13, text_word_to_store);
        editor.putString(TEXT_DEFINITION_13,text_word_def_to_store);
        editor.putInt(PROGRESS_MASTER_13,progressBarMaster.getProgress());
        editor.putInt(PROGRESS_LEARNING_13,progressBarLearning.getProgress());
        editor.putInt(PROGRESS_REVIEWING_13,progressBarReview.getProgress());
        editor.putInt(WORD_LIST_SIZE_13,words.length);
        editor.putInt(WORD_INDEX_13,mGlobalWordNumber);
...
//        loadData();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(getActivity()).getSharedPreferences(SHARED_PREFS_13, Context.MODE_PRIVATE);
        word_index_13=sharedPreferences.getInt(WORD_INDEX_13,mGlobalWordNumber);
        text_master_13=sharedPreferences.getString(TEXT_MASTER_13,tvProgressMaster.getText().toString());
        progress_master_13=sharedPreferences.getInt(PROGRESS_MASTER_13,progressBarMaster.getProgress());
        text_learning_13=sharedPreferences.getString(TEXT_LEARNING_13,tvProgressLearning.getText().toString());
        progress_learning_13=sharedPreferences.getInt(PROGRESS_LEARNING_13,progressBarLearning.getProgress());
        text_reviewing_13=sharedPreferences.getString(TEXT_REVIEWING_13,tvProgressReview.getText().toString());
        progress_reviewing_13=sharedPreferences.getInt(PROGRESS_REVIEWING_13,progressBarReview.getProgress());

        text_word_13=sharedPreferences.getString(TEXT_WORD1_13,words[0]);




        text_def_13=sharedPreferences.getString(TEXT_DEFINITION_13,words_definition[0]);
        word_list_size_13= sharedPreferences.getInt(WORD_LIST_SIZE_13,words.length);
...
//            }
//        }
        tvProgressMaster.setText(text_master_13);
        mGlobalWordNumber=word_index_13;
        tvProgressReview.setText(text_reviewing_13);
        tvProgressLearning.setText(text_learning_13);
        for(int i =0 ; i<words.length; i++){
            if(words[i].equals(text_word_13)){
                word_index_13=i;
            }
        }
        textView_title_front.setText(text_word_13);
        textView_title_back.setText(text_word_13);

        textView_definition.setText(text_def_13);
        progressBarMaster.setProgress((progress_master_13));
        progressBarReview.setProgress((progress_reviewing_13) );
        progressBarLearning.setProgress((progress_learning_13));

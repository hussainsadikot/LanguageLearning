...
public class WordsList14 extends Fragment {
    ...
    public static final String SHARED_PREFS_14 = "sharedPrefs_14";
    public static final String TEXT_MASTER_14 = "text_master_14";
    public static final String PROGRESS_MASTER_14 = "progress_master_14";
    public static final String TEXT_LEARNING_14 = "text_learning_14";
    public static final String PROGRESS_LEARNING_14 = "progress_learning_14";
    public static final String TEXT_REVIEWING_14 = "text_reviewing_14";
    public static final String PROGRESS_REVIEWING_14 = "progress_reviewing_14";
    public static final String TEXT_WORD1_14 = "text_word_14";
    public static final String TEXT_DEFINITION_14 = "text_def_14";
    public static final String WORD_LIST_SIZE_14 = "word_list_size_14";
    public static final String WORD_INDEX_14 = "word_index_14";
    // shared variable default loading
    private   String text_master_14="";
    public Integer progress_master_14=0;
    public  String text_learning_14="";
    public  Integer progress_learning_14=0;
    public String text_reviewing_14="";
    public  Integer progress_reviewing_14=0;
    public  String text_word_14="";
    public  String text_def_14="";
    public int word_list_size_14 =0;
    public int word_index_14;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] words1= getActivity().getResources().getStringArray(R.array.XXIX_Mixed_Words_Part_2__Array_List_14);
        String[] words_definition1= getActivity().getResources().getStringArray(R.array.Definition_Array_List_14);
...
//            word_index_1=word_index_1+1 ;
    ...
    private void saveData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(this.getActivity()).getSharedPreferences(SHARED_PREFS_14, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=  sharedPreferences.edit();
        editor.putString(TEXT_MASTER_14,tvProgressMaster.getText().toString());
        editor.putString(TEXT_REVIEWING_14,tvProgressReview.getText().toString());
        editor.putString(TEXT_LEARNING_14,tvProgressLearning.getText().toString());
        ...
        editor.putString(TEXT_WORD1_14, text_word_to_store);
        editor.putString(TEXT_DEFINITION_14,text_word_def_to_store);
        editor.putInt(PROGRESS_MASTER_14,progressBarMaster.getProgress());
        editor.putInt(PROGRESS_LEARNING_14,progressBarLearning.getProgress());
        editor.putInt(PROGRESS_REVIEWING_14,progressBarReview.getProgress());
        editor.putInt(WORD_LIST_SIZE_14,words.length);
        editor.putInt(WORD_INDEX_14,mGlobalWordNumber);
...
//        loadData();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(getActivity()).getSharedPreferences(SHARED_PREFS_14, Context.MODE_PRIVATE);
        word_index_14=sharedPreferences.getInt(WORD_INDEX_14,mGlobalWordNumber);
        text_master_14=sharedPreferences.getString(TEXT_MASTER_14,tvProgressMaster.getText().toString());
        progress_master_14=sharedPreferences.getInt(PROGRESS_MASTER_14,progressBarMaster.getProgress());
        text_learning_14=sharedPreferences.getString(TEXT_LEARNING_14,tvProgressLearning.getText().toString());
        progress_learning_14=sharedPreferences.getInt(PROGRESS_LEARNING_14,progressBarLearning.getProgress());
        text_reviewing_14=sharedPreferences.getString(TEXT_REVIEWING_14,tvProgressReview.getText().toString());
        progress_reviewing_14=sharedPreferences.getInt(PROGRESS_REVIEWING_14,progressBarReview.getProgress());

        text_word_14=sharedPreferences.getString(TEXT_WORD1_14,words[0]);




        text_def_14=sharedPreferences.getString(TEXT_DEFINITION_14,words_definition[0]);
        word_list_size_14= sharedPreferences.getInt(WORD_LIST_SIZE_14,words.length);
...
//            }
//        }
        tvProgressMaster.setText(text_master_14);
        mGlobalWordNumber=word_index_14;
        tvProgressReview.setText(text_reviewing_14);
        tvProgressLearning.setText(text_learning_14);
        for(int i =0 ; i<words.length; i++){
            if(words[i].equals(text_word_14)){
                word_index_14=i;
            }
        }
        textView_title_front.setText(text_word_14);
        textView_title_back.setText(text_word_14);

        textView_definition.setText(text_def_14);
        progressBarMaster.setProgress((progress_master_14));
        progressBarReview.setProgress((progress_reviewing_14) );
        progressBarLearning.setProgress((progress_learning_14));

...
public class WordsList5 extends Fragment {
    ...
    public static final String SHARED_PREFS_5 = "sharedPrefs_5";
    public static final String TEXT_MASTER_5 = "text_master_5";
    public static final String PROGRESS_MASTER_5 = "progress_master_5";
    public static final String TEXT_LEARNING_5 = "text_learning_5";
    public static final String PROGRESS_LEARNING_5 = "progress_learning_5";
    public static final String TEXT_REVIEWING_5 = "text_reviewing_5";
    public static final String PROGRESS_REVIEWING_5 = "progress_reviewing_5";
    public static final String TEXT_WORD1_5 = "text_word_5";
    public static final String TEXT_DEFINITION_5 = "text_def_5";
    public static final String WORD_LIST_SIZE_5 = "word_list_size_5";
    public static final String WORD_INDEX_5 = "word_index_5";
    // shared variable default loading
    private   String text_master_5="";
    public Integer progress_master_5=0;
    public  String text_learning_5="";
    public  Integer progress_learning_5=0;
    public String text_reviewing_5="";
    public  Integer progress_reviewing_5=0;
    public  String text_word_5="";
    public  String text_def_5="";
    public int word_list_size_5 =0;
    public int word_index_5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] words1= getActivity().getResources().getStringArray(R.array.LEVEL_V_Foods_Drinks_Cooking_and_Utencils_etc_LEVEL_VI_Clothing_House_Parts_of_House_etc__Array_List_5);
        String[] words_definition1= getActivity().getResources().getStringArray(R.array.Definition_Array_List_5);
...
//            word_index_1=word_index_1+1 ;
    ...
    private void saveData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(this.getActivity()).getSharedPreferences(SHARED_PREFS_5, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=  sharedPreferences.edit();
        editor.putString(TEXT_MASTER_5,tvProgressMaster.getText().toString());
        editor.putString(TEXT_REVIEWING_5,tvProgressReview.getText().toString());
        editor.putString(TEXT_LEARNING_5,tvProgressLearning.getText().toString());
        ...
        editor.putString(TEXT_WORD1_5, text_word_to_store);
        editor.putString(TEXT_DEFINITION_5,text_word_def_to_store);
        editor.putInt(PROGRESS_MASTER_5,progressBarMaster.getProgress());
        editor.putInt(PROGRESS_LEARNING_5,progressBarLearning.getProgress());
        editor.putInt(PROGRESS_REVIEWING_5,progressBarReview.getProgress());
        editor.putInt(WORD_LIST_SIZE_5,words.length);
        editor.putInt(WORD_INDEX_5,mGlobalWordNumber);
...
//        loadData();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(getActivity()).getSharedPreferences(SHARED_PREFS_5, Context.MODE_PRIVATE);
        word_index_5=sharedPreferences.getInt(WORD_INDEX_5,mGlobalWordNumber);
        text_master_5=sharedPreferences.getString(TEXT_MASTER_5,tvProgressMaster.getText().toString());
        progress_master_5=sharedPreferences.getInt(PROGRESS_MASTER_5,progressBarMaster.getProgress());
        text_learning_5=sharedPreferences.getString(TEXT_LEARNING_5,tvProgressLearning.getText().toString());
        progress_learning_5=sharedPreferences.getInt(PROGRESS_LEARNING_5,progressBarLearning.getProgress());
        text_reviewing_5=sharedPreferences.getString(TEXT_REVIEWING_5,tvProgressReview.getText().toString());
        progress_reviewing_5=sharedPreferences.getInt(PROGRESS_REVIEWING_5,progressBarReview.getProgress());

        text_word_5=sharedPreferences.getString(TEXT_WORD1_5,words[0]);




        text_def_5=sharedPreferences.getString(TEXT_DEFINITION_5,words_definition[0]);
        word_list_size_5= sharedPreferences.getInt(WORD_LIST_SIZE_5,words.length);
...
//            }
//        }
        tvProgressMaster.setText(text_master_5);
        mGlobalWordNumber=word_index_5;
        tvProgressReview.setText(text_reviewing_5);
        tvProgressLearning.setText(text_learning_5);
        for(int i =0 ; i<words.length; i++){
            if(words[i].equals(text_word_5)){
                word_index_5=i;
            }
        }
        textView_title_front.setText(text_word_5);
        textView_title_back.setText(text_word_5);

        textView_definition.setText(text_def_5);
        progressBarMaster.setProgress((progress_master_5));
        progressBarReview.setProgress((progress_reviewing_5) );
        progressBarLearning.setProgress((progress_learning_5));

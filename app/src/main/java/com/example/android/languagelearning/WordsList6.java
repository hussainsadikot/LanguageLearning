...
public class WordsList6 extends Fragment {
    ...
    public static final String SHARED_PREFS_6 = "sharedPrefs_6";
    public static final String TEXT_MASTER_6 = "text_master_6";
    public static final String PROGRESS_MASTER_6 = "progress_master_6";
    public static final String TEXT_LEARNING_6 = "text_learning_6";
    public static final String PROGRESS_LEARNING_6 = "progress_learning_6";
    public static final String TEXT_REVIEWING_6 = "text_reviewing_6";
    public static final String PROGRESS_REVIEWING_6 = "progress_reviewing_6";
    public static final String TEXT_WORD1_6 = "text_word_6";
    public static final String TEXT_DEFINITION_6 = "text_def_6";
    public static final String WORD_LIST_SIZE_6 = "word_list_size_6";
    public static final String WORD_INDEX_6 = "word_index_6";
    // shared variable default loading
    private   String text_master_6="";
    public Integer progress_master_6=0;
    public  String text_learning_6="";
    public  Integer progress_learning_6=0;
    public String text_reviewing_6="";
    public  Integer progress_reviewing_6=0;
    public  String text_word_6="";
    public  String text_def_6="";
    public int word_list_size_6 =0;
    public int word_index_6;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] words1= getActivity().getResources().getStringArray(R.array.LEVEL_VII_Trees_Vegetables_Fruits_and_Flowers__Array_List_6);
        String[] words_definition1= getActivity().getResources().getStringArray(R.array.Definition_Array_List_6);
...
//            word_index_1=word_index_1+1 ;
    ...
    private void saveData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(this.getActivity()).getSharedPreferences(SHARED_PREFS_6, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=  sharedPreferences.edit();
        editor.putString(TEXT_MASTER_6,tvProgressMaster.getText().toString());
        editor.putString(TEXT_REVIEWING_6,tvProgressReview.getText().toString());
        editor.putString(TEXT_LEARNING_6,tvProgressLearning.getText().toString());
        ...
        editor.putString(TEXT_WORD1_6, text_word_to_store);
        editor.putString(TEXT_DEFINITION_6,text_word_def_to_store);
        editor.putInt(PROGRESS_MASTER_6,progressBarMaster.getProgress());
        editor.putInt(PROGRESS_LEARNING_6,progressBarLearning.getProgress());
        editor.putInt(PROGRESS_REVIEWING_6,progressBarReview.getProgress());
        editor.putInt(WORD_LIST_SIZE_6,words.length);
        editor.putInt(WORD_INDEX_6,mGlobalWordNumber);
...
//        loadData();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(getActivity()).getSharedPreferences(SHARED_PREFS_6, Context.MODE_PRIVATE);
        word_index_6=sharedPreferences.getInt(WORD_INDEX_6,mGlobalWordNumber);
        text_master_6=sharedPreferences.getString(TEXT_MASTER_6,tvProgressMaster.getText().toString());
        progress_master_6=sharedPreferences.getInt(PROGRESS_MASTER_6,progressBarMaster.getProgress());
        text_learning_6=sharedPreferences.getString(TEXT_LEARNING_6,tvProgressLearning.getText().toString());
        progress_learning_6=sharedPreferences.getInt(PROGRESS_LEARNING_6,progressBarLearning.getProgress());
        text_reviewing_6=sharedPreferences.getString(TEXT_REVIEWING_6,tvProgressReview.getText().toString());
        progress_reviewing_6=sharedPreferences.getInt(PROGRESS_REVIEWING_6,progressBarReview.getProgress());

        text_word_6=sharedPreferences.getString(TEXT_WORD1_6,words[0]);




        text_def_6=sharedPreferences.getString(TEXT_DEFINITION_6,words_definition[0]);
        word_list_size_6= sharedPreferences.getInt(WORD_LIST_SIZE_6,words.length);
...
//            }
//        }
        tvProgressMaster.setText(text_master_6);
        mGlobalWordNumber=word_index_6;
        tvProgressReview.setText(text_reviewing_6);
        tvProgressLearning.setText(text_learning_6);
        for(int i =0 ; i<words.length; i++){
            if(words[i].equals(text_word_6)){
                word_index_6=i;
            }
        }
        textView_title_front.setText(text_word_6);
        textView_title_back.setText(text_word_6);

        textView_definition.setText(text_def_6);
        progressBarMaster.setProgress((progress_master_6));
        progressBarReview.setProgress((progress_reviewing_6) );
        progressBarLearning.setProgress((progress_learning_6));

...
public class WordsList7 extends Fragment {
    ...
    public static final String SHARED_PREFS_7 = "sharedPrefs_7";
    public static final String TEXT_MASTER_7 = "text_master_7";
    public static final String PROGRESS_MASTER_7 = "progress_master_7";
    public static final String TEXT_LEARNING_7 = "text_learning_7";
    public static final String PROGRESS_LEARNING_7 = "progress_learning_7";
    public static final String TEXT_REVIEWING_7 = "text_reviewing_7";
    public static final String PROGRESS_REVIEWING_7 = "progress_reviewing_7";
    public static final String TEXT_WORD1_7 = "text_word_7";
    public static final String TEXT_DEFINITION_7 = "text_def_7";
    public static final String WORD_LIST_SIZE_7 = "word_list_size_7";
    public static final String WORD_INDEX_7 = "word_index_7";
    // shared variable default loading
    private   String text_master_7="";
    public Integer progress_master_7=0;
    public  String text_learning_7="";
    public  Integer progress_learning_7=0;
    public String text_reviewing_7="";
    public  Integer progress_reviewing_7=0;
    public  String text_word_7="";
    public  String text_def_7="";
    public int word_list_size_7 =0;
    public int word_index_7;
...
//            word_index_1=word_index_1+1 ;
    ...
    private void saveData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(this.getActivity()).getSharedPreferences(SHARED_PREFS_7, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=  sharedPreferences.edit();
        editor.putString(TEXT_MASTER_7,tvProgressMaster.getText().toString());
        editor.putString(TEXT_REVIEWING_7,tvProgressReview.getText().toString());
        editor.putString(TEXT_LEARNING_7,tvProgressLearning.getText().toString());
        ...
        editor.putString(TEXT_WORD1_7, text_word_to_store);
        editor.putString(TEXT_DEFINITION_7,text_word_def_to_store);
        editor.putInt(PROGRESS_MASTER_7,progressBarMaster.getProgress());
        editor.putInt(PROGRESS_LEARNING_7,progressBarLearning.getProgress());
        editor.putInt(PROGRESS_REVIEWING_7,progressBarReview.getProgress());
        editor.putInt(WORD_LIST_SIZE_7,words.length);
        editor.putInt(WORD_INDEX_7,mGlobalWordNumber);
...
//        loadData();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(getActivity()).getSharedPreferences(SHARED_PREFS_7, Context.MODE_PRIVATE);
        word_index_7=sharedPreferences.getInt(WORD_INDEX_7,mGlobalWordNumber);
        text_master_7=sharedPreferences.getString(TEXT_MASTER_7,tvProgressMaster.getText().toString());
        progress_master_7=sharedPreferences.getInt(PROGRESS_MASTER_7,progressBarMaster.getProgress());
        text_learning_7=sharedPreferences.getString(TEXT_LEARNING_7,tvProgressLearning.getText().toString());
        progress_learning_7=sharedPreferences.getInt(PROGRESS_LEARNING_7,progressBarLearning.getProgress());
        text_reviewing_7=sharedPreferences.getString(TEXT_REVIEWING_7,tvProgressReview.getText().toString());
        progress_reviewing_7=sharedPreferences.getInt(PROGRESS_REVIEWING_7,progressBarReview.getProgress());

        text_word_7=sharedPreferences.getString(TEXT_WORD1_7,words[0]);




        text_def_7=sharedPreferences.getString(TEXT_DEFINITION_7,words_definition[0]);
        word_list_size_7= sharedPreferences.getInt(WORD_LIST_SIZE_7,words.length);
...
//            }
//        }
        tvProgressMaster.setText(text_master_7);
        mGlobalWordNumber=word_index_7;
        tvProgressReview.setText(text_reviewing_7);
        tvProgressLearning.setText(text_learning_7);
        for(int i =0 ; i<words.length; i++){
            if(words[i].equals(text_word_7)){
                word_index_7=i;
            }
        }
        textView_title_front.setText(text_word_7);
        textView_title_back.setText(text_word_7);

        textView_definition.setText(text_def_7);
        progressBarMaster.setProgress((progress_master_7));
        progressBarReview.setProgress((progress_reviewing_7) );
        progressBarLearning.setProgress((progress_learning_7));

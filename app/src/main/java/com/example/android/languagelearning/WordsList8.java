...
public class WordsList8 extends Fragment {
    private Button iknow, idont, reveal;
    private TextView textView_title_front,textView_title_back,textView_title, textView_definition, tv_tag, tvProgressMaster, tvProgressLearning, tvProgressReview;
   ...
   private CardView cardFront,cardBack;
    ...
    public static final String SHARED_PREFS_8 = "sharedPrefs_8";
    public static final String TEXT_MASTER_8 = "text_master_8";
    public static final String PROGRESS_MASTER_8 = "progress_master_8";
    public static final String TEXT_LEARNING_8 = "text_learning_8";
    public static final String PROGRESS_LEARNING_8 = "progress_learning_8";
    public static final String TEXT_REVIEWING_8 = "text_reviewing_8";
    public static final String PROGRESS_REVIEWING_8 = "progress_reviewing_8";
    public static final String TEXT_WORD1_8 = "text_word_8";
    public static final String TEXT_DEFINITION_8 = "text_def_8";
    public static final String WORD_LIST_SIZE_8 = "word_list_size_8";
    public static final String WORD_INDEX_8 = "word_index_8";
    // shared variable default loading
    private   String text_master_8="";
    public Integer progress_master_8=0;
    public  String text_learning_8="";
    public  Integer progress_learning_8=0;
    public String text_reviewing_8="";
    public  Integer progress_reviewing_8=0;
    public  String text_word_8="";
    public  String text_def_8="";
    public int word_list_size_8 =0;
    public int word_index_8;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] words1= getActivity().getResources().getStringArray(R.array.XI_War_Law__XII_Religion_Entertainment_and_Metals_etc__XV_Instrument_Verbs__XVI_Verbs_of_Fighting__XVII_Music_Verbs__Array_List_8);
        String[] words_definition1= getActivity().getResources().getStringArray(R.array.Definition_Array_List_8);
...
//            word_index_1=word_index_1+1 ;
    ...
    private void saveData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(this.getActivity()).getSharedPreferences(SHARED_PREFS_8, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor=  sharedPreferences.edit();
        editor.putString(TEXT_MASTER_8,tvProgressMaster.getText().toString());
        editor.putString(TEXT_REVIEWING_8,tvProgressReview.getText().toString());
        editor.putString(TEXT_LEARNING_8,tvProgressLearning.getText().toString());
        ...
        editor.putString(TEXT_WORD1_8, text_word_to_store);
        editor.putString(TEXT_DEFINITION_8,text_word_def_to_store);
        editor.putInt(PROGRESS_MASTER_8,progressBarMaster.getProgress());
        editor.putInt(PROGRESS_LEARNING_8,progressBarLearning.getProgress());
        editor.putInt(PROGRESS_REVIEWING_8,progressBarReview.getProgress());
        editor.putInt(WORD_LIST_SIZE_8,words.length);
        editor.putInt(WORD_INDEX_8,mGlobalWordNumber);
...
//        loadData();
    ...
    private void loadData() {
        SharedPreferences sharedPreferences= Objects.requireNonNull(getActivity()).getSharedPreferences(SHARED_PREFS_8, Context.MODE_PRIVATE);
        word_index_8=sharedPreferences.getInt(WORD_INDEX_8,mGlobalWordNumber);
        text_master_8=sharedPreferences.getString(TEXT_MASTER_8,tvProgressMaster.getText().toString());
        progress_master_8=sharedPreferences.getInt(PROGRESS_MASTER_8,progressBarMaster.getProgress());
        text_learning_8=sharedPreferences.getString(TEXT_LEARNING_8,tvProgressLearning.getText().toString());
        progress_learning_8=sharedPreferences.getInt(PROGRESS_LEARNING_8,progressBarLearning.getProgress());
        text_reviewing_8=sharedPreferences.getString(TEXT_REVIEWING_8,tvProgressReview.getText().toString());
        progress_reviewing_8=sharedPreferences.getInt(PROGRESS_REVIEWING_8,progressBarReview.getProgress());

        text_word_8=sharedPreferences.getString(TEXT_WORD1_8,words[0]);




        text_def_8=sharedPreferences.getString(TEXT_DEFINITION_8,words_definition[0]);
        word_list_size_8= sharedPreferences.getInt(WORD_LIST_SIZE_8,words.length);
...
//            }
//        }
        tvProgressMaster.setText(text_master_8);
        mGlobalWordNumber=word_index_8;
        tvProgressReview.setText(text_reviewing_8);
        tvProgressLearning.setText(text_learning_8);
        for(int i =0 ; i<words.length; i++){
            if(words[i].equals(text_word_8)){
                word_index_8=i;
            }
        }
        textView_title_front.setText(text_word_8);
        textView_title_back.setText(text_word_8);

        textView_definition.setText(text_def_8);
        progressBarMaster.setProgress((progress_master_8));
        progressBarReview.setProgress((progress_reviewing_8) );
        progressBarLearning.setProgress((progress_learning_8));
